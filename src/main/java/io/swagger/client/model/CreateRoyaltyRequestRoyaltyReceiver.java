...
import io.swagger.client.model.CreateRoyaltyRequestRoyaltyMode;
import io.swagger.client.model.RoyaltyReceiverRoyaltyFeeMode;
...
public class CreateRoyaltyRequestRoyaltyReceiver {
  ...
  private RoyaltyReceiverRoyaltyFeeMode feeModel = null;
  ...
  private CreateRoyaltyRequestRoyaltyMode royaltyMode = null;
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "[REQUIRED] 根据 royalty_mode 参数，如果 royalty_mode = fixed, 则此参数传分润金额，单位元，如果 royalty_mode = rate，此参数传百分比小数， 0.1 表示 10%")
   ...
   * @return fee
  **/
  @ApiModelProperty(required = true, value = "[OPTIONAL] 手续费，单位：元。 如果传递，则每笔分账都会在应分帐金额基础上扣除手续费后再请求支付平台进行分账")
  public Float getFee() {
    return fee;
  }
  ...
  public CreateRoyaltyRequestRoyaltyReceiver feeModel(RoyaltyReceiverRoyaltyFeeMode feeModel) {
   ...
   * @return feeModel
  **/
  @ApiModelProperty(required = true, value = "[OPTIONAL] 手续费模式，fixed 表示固定金额，rate 表示按比例计算手续费。此参数传手续费比例，0.1 表示 10%")
  public RoyaltyReceiverRoyaltyFeeMode getFeeModel() {
    return feeModel;
  }

  public void setFeeModel(RoyaltyReceiverRoyaltyFeeMode feeModel) {
    this.feeModel = feeModel;
  }
   ...
   * @return feeRatio
  **/
  @ApiModelProperty(required = true, value = "[OPTIONAL] 手续费比例，与 手续费 字段二选一即可ratio")
   ...
   * @return ratio
  **/
  @ApiModelProperty(required = true, value = "[OPTIONAL] 根据 royalty_mode 参数，如果 royalty_mode = fixed, 此参数无效，如果 royalty_mode = rate，此参数传分润比例，0.1 表示 10%")
  ...
  **/
  @ApiModelProperty(required = true, value = "接受方的商业用户ID")
  ...
  public CreateRoyaltyRequestRoyaltyReceiver royaltyMode(CreateRoyaltyRequestRoyaltyMode royaltyMode) {
   ...
   * @return royaltyMode
  **/
  @ApiModelProperty(required = true, value = "[REQUIRED] 分润模式，free 表示不收取，fixed 表示固定金额，rate 表示按比例分润")
  public CreateRoyaltyRequestRoyaltyMode getRoyaltyMode() {
    return royaltyMode;
  }

  public void setRoyaltyMode(CreateRoyaltyRequestRoyaltyMode royaltyMode) {
    this.royaltyMode = royaltyMode;
  }
