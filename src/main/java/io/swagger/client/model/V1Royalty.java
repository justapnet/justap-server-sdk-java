...
public class V1Royalty {
   ...
   * @return chargeId
  **/
  @ApiModelProperty(required = true, value = "Charge ID")
  ...
  public V1Royalty created(Long created) {
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "分账的原因描述，分账账单中需要体现，不超过 80 个字符")
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "分账 ID")
  public String getId() {
    return id;
  }
  ...
  **/
   ...
   * @return method
  **/
  @ApiModelProperty(required = true, value = "分账方式")
  ...
  **/
   ...
   * @return orderId
  **/
  @ApiModelProperty(required = true, value = "订单 ID")
  ...
  **/
  @ApiModelProperty(required = true, value = "付款方结算账户 ID")
   ...
   * @return payerUserId
  **/
  @ApiModelProperty(required = true, value = "付款方用户 ID")
  ...
  **/
  ...
  public V1Royalty timeSettled(Long timeSettled) {
