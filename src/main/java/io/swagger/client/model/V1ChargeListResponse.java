...
import io.swagger.client.model.V1Charge;
...
public class V1ChargeListResponse {
  ...
  public V1ChargeListResponse addDataItem(V1Charge dataItem) {
    if (this.data == null) {
   ...
   * @return data
  **/
  @ApiModelProperty(value = "包含一个由请求参数分页后的返回对象实体")
  public List<V1Charge> getData() {
    return data;
  }

  public void setData(List<V1Charge> data) {
    this.data = data;
  }

  public V1ChargeListResponse hasMore(Boolean hasMore) {
  ...
  **/
  ...
  public V1ChargeListResponse object(String object) {
    this.object = object;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ChargeListResponse v1ChargeListResponse = (V1ChargeListResponse) o;
    return Objects.equals(this.data, v1ChargeListResponse.data) &&
        Objects.equals(this.hasMore, v1ChargeListResponse.hasMore) &&
        Objects.equals(this.object, v1ChargeListResponse.object);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ChargeListResponse {\n");
