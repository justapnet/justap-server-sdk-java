...
public class SettlementAccountRecipientWechatpayChannelRecipient {
  ...
  public SettlementAccountRecipientWechatpayChannelRecipient account(String account) {
   ...
   * @return account
  **/
  @ApiModelProperty(required = true, value = "微信支付分账接收方账户，OPENID或者商户号")
  ...
  public SettlementAccountRecipientWechatpayChannelRecipient accountType(SettlementAccountRecipientAccountType accountType) {
   ...
   * @return accountType
  **/
  @ApiModelProperty(required = true, value = "微信支付分账接收方账户类型")
   ...
   * @return appId
  **/
  @ApiModelProperty(required = true, value = "微信支付分账接收方 openid 所对应的服务商公众号 ID")
   ...
   * @return forceCheck
  **/
  @ApiModelProperty(required = true, value = "是否强制校验收款人姓名")
  ...
  public SettlementAccountRecipientWechatpayChannelRecipient name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "微信支付分账接收方姓名或名称")
  ...
  public SettlementAccountRecipientWechatpayChannelRecipient subAppId(String subAppId) {
   ...
   * @return subAppId
  **/
  @ApiModelProperty(required = true, value = "微信支付分账接收方 openid 所对应的商户公众号 ID")
  ...
  public SettlementAccountRecipientWechatpayChannelRecipient type(SettlementAccountRecipientRecipientType type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "微信支付分账接收方类型")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.account, settlementAccountRecipientWechatpayChannelRecipient.account) &&
        ...
        Objects.equals(this.subAppId, settlementAccountRecipientWechatpayChannelRecipient.subAppId) &&
        Objects.equals(this.type, settlementAccountRecipientWechatpayChannelRecipient.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(account, accountType, appId, forceCheck, name, subAppId, type);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettlementAccountRecipientWechatpayChannelRecipient {\n");
