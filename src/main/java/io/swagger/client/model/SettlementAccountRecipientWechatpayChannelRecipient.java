...
public class SettlementAccountRecipientWechatpayChannelRecipient {
   ...
   * @return account
  **/
  @ApiModelProperty(value = "微信支付分账接收方账户，OPENID或者商户号")
   ...
   * @return accountType
  **/
  @ApiModelProperty(value = "微信支付分账接收方账户类型")
  ...
  **/
   ...
   * @return forceCheck
  **/
  @ApiModelProperty(value = "是否强制校验收款人姓名")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "微信支付分账接收方姓名或名称")
   ...
   * @return type
  **/
  @ApiModelProperty(value = "微信支付分账接收方类型")
