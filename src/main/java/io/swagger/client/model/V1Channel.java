 ...
 */
@JsonAdapter(V1Channel.Adapter.class)
public enum V1Channel {
  ...
  public static V1Channel fromValue(String text) {
    for (V1Channel b : V1Channel.values()) {
  ...
  public static class Adapter extends TypeAdapter<V1Channel> {
    @Override
    public void write(final JsonWriter jsonWriter, final V1Channel enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public V1Channel read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return V1Channel.fromValue(String.valueOf(value));
    }
  }
}
