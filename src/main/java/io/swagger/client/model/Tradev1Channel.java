 ...
 */
@JsonAdapter(Tradev1Channel.Adapter.class)
public enum Tradev1Channel {
  ...
  public static Tradev1Channel fromValue(String text) {
    for (Tradev1Channel b : Tradev1Channel.values()) {
  ...
  public static class Adapter extends TypeAdapter<Tradev1Channel> {
    @Override
    public void write(final JsonWriter jsonWriter, final Tradev1Channel enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Tradev1Channel read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Tradev1Channel.fromValue(String.valueOf(value));
    }
  }
}
