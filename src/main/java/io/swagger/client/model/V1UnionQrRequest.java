...
public class V1UnionQrRequest {
  ...
  **/
   ...
   * @return appid
  **/
  @ApiModelProperty(required = true, value = "openid 对应的应用id")
   ...
   * @return browserAgent
  **/
  @ApiModelProperty(required = true, value = "浏览器信息")
  ...
  **/
   ...
   * @return inApp
  **/
  @ApiModelProperty(required = true, value = "打开的app类型，微信/支付宝/qq/闪付")
   ...
   * @return openid
  **/
  @ApiModelProperty(required = true, value = "用户openid")
  ...
  **/
   ...
   * @return s
  **/
  @ApiModelProperty(required = true, value = "设备编号的签名")
  public String getS() {
    return s;
  }
