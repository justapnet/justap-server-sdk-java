...
public class V1ExtraWechatpayNative {
  ...
  public V1ExtraWechatpayNative attach(String attach) {
    this.attach = attach;
    return this;
  }
  ...
  **/
  ...
  public V1ExtraWechatpayNative detail(V1ExtraWechatpayDetail detail) {
    this.detail = detail;
    return this;
  }
  ...
  **/
  ...
  public V1ExtraWechatpayNative goodsTag(String goodsTag) {
  ...
  **/
  ...
  public V1ExtraWechatpayNative qrCode(String qrCode) {
    this.qrCode = qrCode;
    return this;
  }
   ...
   * @return qrCode
  **/
  @ApiModelProperty(required = true, value = "二维码数据")
  ...
  public V1ExtraWechatpayNative qrLink(String qrLink) {
    this.qrLink = qrLink;
    return this;
  }
   ...
   * @return qrLink
  **/
  @ApiModelProperty(required = true, value = "二维码链接")
  ...
  public V1ExtraWechatpayNative sceneInfo(V1ExtraWechatpaySceneInfo sceneInfo) {
  ...
  **/
  ...
  public V1ExtraWechatpayNative settleInfo(V1ExtraWechatpaySettleInfo settleInfo) {
  ...
  **/
  ...
  public V1ExtraWechatpayNative timeExpire(String timeExpire) {
   ...
   * @return timeExpire
  **/
  @ApiModelProperty(required = true, value = "交易过期时间")
  ...
  public V1ExtraWechatpayNative timeStart(String timeStart) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1ExtraWechatpayNative v1ExtraWechatpayNative = (V1ExtraWechatpayNative) o;
    return Objects.equals(this.attach, v1ExtraWechatpayNative.attach) &&
        Objects.equals(this.detail, v1ExtraWechatpayNative.detail) &&
        Objects.equals(this.goodsTag, v1ExtraWechatpayNative.goodsTag) &&
        Objects.equals(this.qrCode, v1ExtraWechatpayNative.qrCode) &&
        Objects.equals(this.qrLink, v1ExtraWechatpayNative.qrLink) &&
        Objects.equals(this.sceneInfo, v1ExtraWechatpayNative.sceneInfo) &&
        Objects.equals(this.settleInfo, v1ExtraWechatpayNative.settleInfo) &&
        Objects.equals(this.timeExpire, v1ExtraWechatpayNative.timeExpire) &&
        Objects.equals(this.timeStart, v1ExtraWechatpayNative.timeStart);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attach, detail, goodsTag, qrCode, qrLink, sceneInfo, settleInfo, timeExpire, timeStart);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1ExtraWechatpayNative {\n");
