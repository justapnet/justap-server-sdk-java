...
public class V1ExtraWechatpaySceneInfo {
  ...
  private ExtraWechatpaySceneInfoStoreInfo storeInfo = null;

  public V1ExtraWechatpaySceneInfo deviceId(String deviceId) {
  ...
  **/
  ...
  public V1ExtraWechatpaySceneInfo storeInfo(ExtraWechatpaySceneInfoStoreInfo storeInfo) {
  ...
  **/
  @ApiModelProperty(value = "")
  public ExtraWechatpaySceneInfoStoreInfo getStoreInfo() {
    return storeInfo;
  }

  public void setStoreInfo(ExtraWechatpaySceneInfoStoreInfo storeInfo) {
    this.storeInfo = storeInfo;
  }
