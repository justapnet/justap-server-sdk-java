...
public class BusinessUserServiceApi {
    private ApiClient apiClient;

    public BusinessUserServiceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public BusinessUserServiceApi(ApiClient apiClient) {
    ...
    /**
     * 创建 BusinessUser 对象 (asynchronously)
     * 
     * @param body  (required)
    ...
    /**
     * 删除 BusinessUser 对象 (asynchronously)
     * 
     * @param id  (required)
     * @param appId  (optional)
     * @param callback The callback to be executed when the API call finishes
    ...
    /**
     * 查询 BusinessUser 对象列表 (asynchronously)
     * 
     * @param appId  (optional)
     * @param limit [OPTIONAL] 限制有多少对象可以被返回，限制范围是从 1~100 项，默认是 10 项 (optional, default to 10)
     * @param startingAfter [OPTIONAL] 在分页时使用的指针，决定了列表的第一项从何处开始。假设你的一次请求返回列表的最后一项的 id 是 obj_end，你可以使用 starting_after &#x3D; obj_end 去获取下一页 (optional)
    ...
    /**
     * 查询 BusinessUser 对象 (asynchronously)
     * 
     * @param id  (required)
     * @param appId  (optional)
     * @param callback The callback to be executed when the API call finishes
    ...
    /**
     * 搜索 BusinessUser 对象 (asynchronously)
     * 
     * @param appId  (optional)
     * @param limit [OPTIONAL] 限制有多少对象可以被返回，限制范围是从 1~100 项，默认是 10 项 (optional, default to 10)
     * @param createdLt 大于 BusinessUser 对象的创建时间，用 Unix 时间戳表示 (optional, default to 0)
     ...
     * @param gender  - GENDER_UNKNOWN: 未设置  - MALE: 男  - FE_MALE: 女  - PRIVACY: 保密  - ThirdGender: 第三性别 (optional, default to GENDER_UNKNOWN)
     * @param parentUserId  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call businessUserServiceUpdateUserCall(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentUserId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("parent_user_id", parentUserId));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call businessUserServiceUpdateUserValidateBeforeCall(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentUserId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling businessUserServiceUpdateUser(Async)");
        }
        

        com.squareup.okhttp.Call call = businessUserServiceUpdateUserCall(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentUserId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V1UserResponse businessUserServiceUpdateUser(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentUserId) throws ApiException {
        ApiResponse<V1UserResponse> resp = businessUserServiceUpdateUserWithHttpInfo(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentUserId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1UserResponse> businessUserServiceUpdateUserWithHttpInfo(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentUserId) throws ApiException {
        com.squareup.okhttp.Call call = businessUserServiceUpdateUserValidateBeforeCall(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentUserId, null, null);
        Type localVarReturnType = new TypeToken<V1UserResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * 更新 BusinessUser 对象 (asynchronously)
     * 
     * @param id  (required)
     * @param appId  (optional)
     * @param address  (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call businessUserServiceUpdateUserAsync(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentUserId, final ApiCallback<V1UserResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = businessUserServiceUpdateUserValidateBeforeCall(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentUserId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1UserResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
