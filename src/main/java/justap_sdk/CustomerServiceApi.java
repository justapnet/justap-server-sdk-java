...
public class CustomerServiceApi {
     ...
     * @param parentCustomerId  (optional)
     * @param outCustomerId  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call customerServiceUpdateCustomerCall(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentCustomerId, String outCustomerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("parent_customer_id", parentCustomerId));
        if (outCustomerId != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("out_customer_id", outCustomerId));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call customerServiceUpdateCustomerValidateBeforeCall(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentCustomerId, String outCustomerId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = customerServiceUpdateCustomerCall(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentCustomerId, outCustomerId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public V1CustomerResponse customerServiceUpdateCustomer(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentCustomerId, String outCustomerId) throws ApiException {
        ApiResponse<V1CustomerResponse> resp = customerServiceUpdateCustomerWithHttpInfo(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentCustomerId, outCustomerId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<V1CustomerResponse> customerServiceUpdateCustomerWithHttpInfo(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentCustomerId, String outCustomerId) throws ApiException {
        com.squareup.okhttp.Call call = customerServiceUpdateCustomerValidateBeforeCall(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentCustomerId, outCustomerId, null, null);
        Type localVarReturnType = new TypeToken<V1CustomerResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call customerServiceUpdateCustomerAsync(String id, String appId, String address, String currency, String description, String email, String name, String phone, String avatar, Boolean disabled, String gender, String parentCustomerId, String outCustomerId, final ApiCallback<V1CustomerResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = customerServiceUpdateCustomerValidateBeforeCall(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentCustomerId, outCustomerId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<V1CustomerResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
