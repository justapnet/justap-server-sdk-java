...
/**
 * API tests for SettlementServiceApi
 */
@Ignore
public class SettlementServiceApiTest {

    private final SettlementServiceApi api = new SettlementServiceApi();
    ...
    public void settlementServiceCreateSettlementAccountTest() throws Exception {
        ...
        String channel = null;
        String recipientWechatpayChannelRecipientAccount = null;
        String recipientWechatpayChannelRecipientName = null;
        ...
        String recipientAlipayChannelRecipientAccountType = null;
        String recipientBankChannelRecipientAccount = null;
        String recipientBankChannelRecipientName = null;
        String recipientBankChannelRecipientType = null;
        String recipientBankChannelRecipientBankName = null;
    ...
    public void settlementServiceListAllSettlementAccountsTest() throws Exception {
        ...
        String customerId = null;
        String userId = null;
        V1SettlementAccountListResponse response = api.settlementServiceListAllSettlementAccounts(appId, limit, startingAfter, endingBefore, createdLt, createdLte, createdGt, createdGte, disabled, customerId, userId);
    ...
    public void settlementServiceRetrieveSettlementAccountTest() throws Exception {
        ...
        String dataRecipientWechatpayChannelRecipientAccount = null;
        String dataRecipientWechatpayChannelRecipientName = null;
        ...
        String dataRecipientAlipayChannelRecipientAccountType = null;
        String dataRecipientBankChannelRecipientAccount = null;
        String dataRecipientBankChannelRecipientName = null;
        String dataRecipientBankChannelRecipientType = null;
        String dataRecipientBankChannelRecipientBankName = null;
        String dataRecipientBankChannelRecipientBankBranch = null;
        String dataRecipientBankChannelRecipientBankProvince = null;
        String dataRecipientBankChannelRecipientBankCity = null;
