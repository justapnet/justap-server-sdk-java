...
/**
 * API tests for BusinessUserServiceApi
 */
@Ignore
public class BusinessUserServiceApiTest {

    private final BusinessUserServiceApi api = new BusinessUserServiceApi();
    ...
    public void businessUserServiceUpdateUserTest() throws Exception {
        ...
        V1UserResponse response = api.businessUserServiceUpdateUser(id, appId, address, currency, description, email, name, phone, avatar, disabled, gender, parentUserId);
