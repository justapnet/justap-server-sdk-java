...
/**
 * API tests for CheckoutServiceApi
 */
@Ignore
public class CheckoutServiceApiTest {

    private final CheckoutServiceApi api = new CheckoutServiceApi();
     ...
     */
    @Test
    public void checkoutServiceCreateUnionQrCheckoutTest() throws Exception {
        V1UnionQrRequest body = null;
        V1UnionQrRequest response = api.checkoutServiceCreateUnionQrCheckout(body);
